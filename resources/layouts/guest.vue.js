...
function __VLS_template() {
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ ...{ class: ("min-h-screen bg-indigo-600 flex flex-col sm:justify-center items-center pt-6 sm:pt-0  dark:bg-gray-900") }, });
    ...
    __VLS_styleScopedClasses['sm:rounded-lg'];
    var __VLS_slots;
...
export default {};
;
//# sourceMappingURL=guest.vue.js.map