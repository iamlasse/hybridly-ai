    ...
    <dialog-root :open=" show ">
        <dialog-portal>
            ...
            data-[state=open]:slide-in-from-right data-[state=closed]:slide-out-to-right" @interact-outside=" close "
                @escape-key-down=" close " @pointer-down-outside=" close " @after-leave=" unmount ">
                <DialogTitle as-child
                    class="text-lg border-b font-medium text-gray-900 flex items-center justify-between p-4">
