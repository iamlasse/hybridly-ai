<template>
  <div class="">
    <div class="">
      <h1 class="mb-4 text-2xl font-bold text-white dark:text-white">
      ...
      <ul class="flex gap-2 flex-wrap">
        ...
        >
          ...
          >
            ...
            >
              <h2 class="text-xl font-bold text-white truncate pr-3">
                {{ project.name }}
              </h2>
              <span
                :class="projectClass(project.status)"
            ...
            <div class="p-4 flex-1 flex flex-col justify-between">
              ...
              <div class="flex justify-between items-center">
                ...
                >
                  <v-icon name="fa-tasks" scale="0.8" class="inline mr-1" />
                  {{ project.tasks_count }}
                </span>
                <span
