...
function __VLS_template() {
    ...
    // @ts-ignore
    const __VLS_13 = __VLS_asFunctionalComponent(__VLS_12, new __VLS_12({ ...{ 'onPointerDownOutside': {} }, ...{ class: ((__VLS_ctx.cn('relative z-50 grid w-full max-w-lg my-8 gap-4 border border-slate-200 bg-white p-6 shadow-lg duration-200 sm:rounded-lg md:w-full dark:border-slate-800 dark:bg-slate-950', props.class))) }, ...(__VLS_ctx.forwarded), }));
    const __VLS_14 = __VLS_13({ ...{ 'onPointerDownOutside': {} }, ...{ class: ((__VLS_ctx.cn('relative z-50 grid w-full max-w-lg my-8 gap-4 border border-slate-200 bg-white p-6 shadow-lg duration-200 sm:rounded-lg md:w-full dark:border-slate-800 dark:bg-slate-950', props.class))) }, ...(__VLS_ctx.forwarded), }, ...__VLS_functionalComponentArgsRest(__VLS_13));
    let __VLS_18;
    const __VLS_19 = {
    ...
    // @ts-ignore
    const __VLS_22 = __VLS_asFunctionalComponent(__VLS_21, new __VLS_21({ ...{ class: ("absolute top-4 right-4 p-0.5 transition-colors rounded-md hover:bg-slate-100 dark:hover:bg-slate-800") }, }));
    const __VLS_23 = __VLS_22({ ...{ class: ("absolute top-4 right-4 p-0.5 transition-colors rounded-md hover:bg-slate-100 dark:hover:bg-slate-800") }, }, ...__VLS_functionalComponentArgsRest(__VLS_22));
    const __VLS_27 = __VLS_resolvedLocalAndGlobalComponents.Cross2Icon;
    ...
    __VLS_styleScopedClasses['dark:hover:bg-slate-800'];
