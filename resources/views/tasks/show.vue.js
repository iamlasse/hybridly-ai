...
function __VLS_template() {
    ...
    for (const [comment] of __VLS_getVForSourceType((__VLS_ctx.comments))) {
        const __VLS_6 = __VLS_resolvedLocalAndGlobalComponents.CComment;
    ...
    // @ts-ignore
    const __VLS_13 = __VLS_asFunctionalComponent(__VLS_12, new __VLS_12({ ...{ class: ("border-0 w-full") }, type: ("text"), name: ("body"), modelValue: ((__VLS_ctx.commentForm.fields.body)), }));
